...
public class CONF {
    ...
    public static int FOX_INIT_MIN_ENERGY = 10;  public static int FOX_INIT_MAX_ENERGY = 20;
    public static int FOX_INIT_MIN_AGE = 5;      public static int FOX_INIT_MAX_AGE = 25;
    public static int FOX_INIT_MIN_SATIETY = 10; public static int FOX_INIT_MAX_SATIETY = 10;
